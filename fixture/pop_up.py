...
class PopUp:
    ...
    location_dropdown_employee_values = 'ul[id^="select-options"][style*="display: block"] li'            #sfr'ul[id^="select-options"][style*="display: block"] li span'

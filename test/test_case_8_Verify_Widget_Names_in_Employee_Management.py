...
list_of_expected_configurations = ['Annual Basic Payment by Location', 'Buzz Latest Posts', "Current Year's Leave Taken by Department", 'Employees on Leave Today', 'Headcount by Location', 'Latest Documents', 'Latest News', 'Leave Scheduled in Each Month', 'Leave Taken on Each Calendar Month Over the Years', 'Leave Taken on Each Day of the Week Over Time', 'My Actions', 'Quick Access', 'Time At Work']

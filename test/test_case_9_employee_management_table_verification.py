...
def test_case_9_employee_management_table_verification(app):
    ...
    # 3 Get list of elements from each defined column and assert them with the expected one.t
...
def test_case_9_1_employee_management_table_filtering(app):
    ...
    # Wait for the table to load (ensure the table is refreshed with the filter applied)fs

...
def test_case_7_Verify_Employee_Name_Autocomplete_Suggestion(app):
    ...
    app.orangeHrm.popUp.set_employee_name_filter('Odis')
    app.assert_that(app.orangeHrm.popUp.get_employee_name_dropdown_text()).contains('Odis Adalwin', 'Kgosi Modise')
...
def test_case_7_1_Verify_No_Results_Found_Error_Message(app):
    ...
    app.orangeHrm.sideMenu.click_on_side_menu_button('HR Administration')
    app.orangeHrm.hrAdministration.click_on_filter()
    app.orangeHrm.popUp.set_employee_name_filter('Irina')
...
def test_case_7_3_Verify_Reset_Button_Functionality(app):
    ...
    app.orangeHrm.hrAdministration.click_on_filter()
    app.assert_that(app.orangeHrm.popUp.get_filter_table_name()).is_equal_to("Filter Users")
    app.orangeHrm.popUp.set_hr_administration_drop_downs(user_name="Admin", employee_name="employee",
                                                         ess_role="Default ESS", admin_role="Leave Admin",
                                                        supervisor_role="Default Supervisor", status="Disabled",
